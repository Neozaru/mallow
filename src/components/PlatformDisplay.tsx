...
const platformIcons = {
  ...
  bitstamp: "https://assets.coingecko.com/markets/images/9/large/bitstamp.jpg",
...
const tokenIcons = {
  ...
  'USD₮0': tokenLogo('usdt0.png'),
  aUSDT0: tokenLogo('usdt0.png'),
  'aUSD₮0': tokenLogo('usdt0.png'),
  ptaUSDT0: tokenLogo('usdt0.png'),
